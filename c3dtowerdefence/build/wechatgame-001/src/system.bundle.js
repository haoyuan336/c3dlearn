(function () {
  ...
  */
  ...
  /**
   * Creator - Note, some platforms do not support loading script from <script> element.
   * So we must explicit disable here.
   */
  (function (global) {
    const System = global.System;
    const systemJSPrototype = System.constructor.prototype;
    systemJSPrototype.createScript = function (url, firstParentUrl) {
        throw new Error("You are trying to load " + url + " from " + firstParentUrl +". However your platform does not support loading script through DOM.");
    };
  })(typeof self !== 'undefined' ? self : global);
